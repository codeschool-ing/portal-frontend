...
window.SAMPLE_EXERCISES = (window.SAMPLE_EXERCISES || []).concat([
  ...
  /* ============================================================== lesson 04 */
  {
    id: 'hc-04-quiz',
    course: 'html-css',
    topic: 'Seletores, cascata, herança e especificidade',
    type: 'quiz',
    difficulty: 'medium',
    statement: 'Duas regras atingem o mesmo elemento: `#painel p { color: red }` e `.aviso.destaque p { color: blue }`. Qual cor vence, e por quê?',
    socratic_hint: 'A especificidade é um trio comparado da esquerda para a direita. Quantas classes seriam necessárias para superar um id?',
    options: [
      {
  ...
  },
  {
    ...
    type: 'matching',
    difficulty: 'medium',
    statement: 'Associe cada seletor ao que ele atinge. Sobram opções na coluna da direita.',
    socratic_hint: 'Dois deles diferem por um único caractere entre os nomes, e essa diferença é a distância na árvore.',
    pairs: [
  ...
  /* ============================================================== lesson 05 */
  {
    id: 'hc-05-quiz',
    course: 'html-css',
    topic: 'Modelo de caixa, box-sizing e unidades (px, rem, em, %, vw/vh)',
    type: 'quiz',
    difficulty: 'easy',
    statement: 'Um elemento tem `width: 200px`, `padding: 20px` e `border: 2px`. Quanto ele ocupa na horizontal, no comportamento padrão do CSS?',
    socratic_hint: 'No padrão, `width` mede apenas uma das quatro camadas da caixa. Qual delas — e as outras entram para dentro ou para fora?',
    options: [
  ...
  },
  {
    ...
    difficulty: 'medium',
    statement: 'Marque as afirmações verdadeiras sobre unidades.',
    socratic_hint: 'Uma delas é a razão de tamanho de texto em pixel ser um problema de acessibilidade. Outra trata de uma unidade que acumula quando os elementos se aninham.',
    options: [
  ...
  /* ============================================================== lesson 07 */
  {
    id: 'hc-07-quiz',
    course: 'html-css',
    topic: 'Flexbox: eixos, alinhamento e distribuição',
    type: 'quiz',
    difficulty: 'medium',
    statement: 'Num contêiner com `display: flex` e `flex-direction: column`, o que `justify-content: center` faz?',
    socratic_hint: 'As duas propriedades de alinhamento não são "horizontal" e "vertical": elas são "principal" e "cruzado". O que `flex-direction` acabou de mudar?',
    options: [
  ...
  },
  {
    ...
    type: 'matching',
    difficulty: 'hard',
    statement: 'Associe cada declaração ao comportamento do item. Sobram opções na coluna da direita.',
    socratic_hint: 'Duas delas diferem só na base — `0` ou `auto` —, e é a base que decide se o conteúdo do item influencia a largura final.',
    pairs: [
  ...
  /* ============================================================== lesson 10 */
  {
    id: 'hc-10-ord',
    course: 'html-css',
    topic: 'Responsividade: mobile first, media queries e container queries',
    type: 'ordering',
    difficulty: 'medium',
    statement: 'Ponha em ordem os passos de escrever um componente responsivo em mobile first.',
    socratic_hint: 'Um dos passos não tem media query nenhuma, e é justamente por isso que ele vem primeiro. Medir vem antes de escolher onde quebrar?',
    items: [
  ...
  },
  {
    ...
    type: 'quiz',
    difficulty: 'hard',
    statement: 'Um cartão reutilizável aparece ora numa barra estreita, ora ocupando a tela inteira. Com media query, ele fica errado num dos dois. Por quê?',
    socratic_hint: 'A media query pergunta o tamanho de quê? E é essa a medida que determina o espaço que o cartão realmente recebeu?',
    options: [
      {
