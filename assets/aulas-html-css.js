  ...
  'html-css': {
    ...
    'Flexbox: eixos, alinhamento e distribuição': [
      ...
      },
      {
        ...
        corpo: [
          'Centralizar nos dois sentidos, que já foi um quebra-cabeça, hoje são três linhas:',
          { codigo: 'css', texto: '.centro {\n  display: flex;\n  justify-content: center;  /* eixo principal */\n  align-items: center;      /* eixo cruzado */\n}' },
          ...
          'Use **`gap`** para o espaço entre itens, e não margem: `gap` não sobra na ponta, não colapsa e não precisa daquele `:last-child { margin: 0 }` que todo CSS antigo tem.',
        ],
      },
      {
        id: 'crescer',
