...
window.AULAS = Object.assign(window.AULAS || {}, {
  ...
  'html-css': {
    ...
    'Formulários, campos, rótulos e validação nativa': [
      ...
      {
        id: 'tipos',
        titulo: 'O tipo do campo muda o teclado',
        corpo: [
    ...
    'Tabelas, imagens responsivas e mídia': [
      {
        id: 'tabelas',
        titulo: 'Tabela é para dado, não para layout',
        corpo: [
    ...
    'Seletores, cascata, herança e especificidade': [
      ...
      {
        id: 'cascata',
        titulo: 'Cascata e herança são coisas diferentes',
        corpo: [
    ...
    'Posicionamento: static, relative, absolute, fixed e sticky': [
      {
        id: 'fluxo',
        titulo: 'O fluxo normal, e sair um pouco dele',
        corpo: [
      ...
      {
        id: 'absolute',
        titulo: 'absolute e o contexto de posicionamento',
        corpo: [
          ...
          { codigo: 'css', texto: '.cartao      { position: relative; }\n.cartao .selo {\n  position: absolute;\n  top: 8px;\n  right: 8px;\n}' },
      ...
      },
      {
        ...
        corpo: [
          ...
          { codigo: 'css', texto: '.cabecalho-tabela {\n  position: sticky;\n  top: 0;\n}' },
    ...
    'Flexbox: eixos, alinhamento e distribuição': [
      {
        ...
        corpo: [
          ...
          'A pergunta certa nunca é "como centralizo na horizontal?", e sim "qual é o meu eixo principal?".',
          {
            ...
            legenda: 'Trocar `row` por `column` não move só os itens: **troca de lugar** as duas propriedades de alinhamento. É por isso que a que funcionava "parou de funcionar".',
          },
        ],
      },
      {
          ...
          'Centralizar nos dois sentidos, que já foi um quebra-cabeça, hoje são três linhas. Em vez de mostrar as três soltas, vale ler uma barra de navegação inteira — que é onde essas propriedades realmente aparecem — com a explicação de cada trecho ao lado dele:',
          {
            exemplo: {
              ...
              partes: [
                {
                  codigo: '.barra {\n  display: flex;',
                  nota: 'A partir daqui os filhos diretos de `.barra` são itens flex. Nada acontece com os netos — flex vale um nível só.',
                },
                {
                  codigo: '  align-items: center;',
                  nota: 'Alinha no eixo **cruzado**. Com `flex-direction: row` (o padrão), o cruzado é a vertical: é isto que deixa a logo e os links na mesma altura mesmo tendo tamanhos diferentes.',
                },
                {
                  codigo: '  gap: 24px;',
                  nota: 'O espaço entre os itens. `gap` não sobra na ponta, não colapsa, e dispensa o `:last-child { margin: 0 }` que todo CSS antigo carrega.',
                },
                {
                  codigo: '  padding: 0 32px;\n}',
                  nota: 'Espaço interno da barra. Repare que ele NÃO é `gap`: um é a moldura, o outro é a distância entre os itens.',
                },
                {
                  codigo: '.barra .menu {\n  margin-left: auto;\n}',
                  nota: 'O truque mais útil do flexbox. `margin: auto` come todo o espaço livre daquele lado, então este item — e tudo depois dele — é empurrado para a direita. Faz o que `justify-content: space-between` faria, mas para UM item, e sem mexer no resto.',
                },
                {
                  codigo: '.barra .titulo {\n  min-width: 0;\n}',
                  nota: 'A linha mais misteriosa e mais útil. Um item flex não encolhe abaixo do próprio conteúdo por padrão, e um título longo estoura a barra em vez de reticenciar. `min-width: 0` devolve a permissão de encolher.',
                },
              ],
        ...
        materiais: ['hc-flex-mapa'],
      },
      {
        id: 'crescer',
        titulo: 'Crescer, encolher e a base',
        corpo: [
    ...
    'CSS Grid: linhas, colunas, áreas e grid implícito': [
      {
        id: 'linhas-colunas',
        titulo: 'Duas dimensões de uma vez',
        corpo: [
      ...
      {
        id: 'implicito',
        titulo: 'Grid implícito e grades que se ajustam',
        corpo: [
    ...
    'Variáveis CSS e organização de estilos': [
      ...
      {
        id: 'tema',
        titulo: 'Tema claro e escuro com uma chave',
        corpo: [
      ...
      {
        id: 'organizar',
        titulo: 'Organizar sem virar arqueologia',
        corpo: [
    ...
    'Responsividade: mobile first, media queries e container queries': [
      {
        id: 'mobile-first',
        titulo: 'Mobile first é sobre o que é padrão',
        corpo: [
      ...
      {
        id: 'container',
        titulo: 'Container queries: o componente que se mede',
        corpo: [
    ...
    'Transições, animações e transformações': [
      ...
      },
      {
        ...
        corpo: [
          ...
          { codigo: 'css', texto: '@media (prefers-reduced-motion: reduce) {\n  * { animation: none !important; transition: none !important; }\n}' },
        ],
      },
    ],
    ...
    'Tailwind CSS: utilitários, configuração e componentes': [
      {
        id: 'utilitarios',
        titulo: 'A ideia: uma classe, uma propriedade',
        corpo: [
          ...
          { codigo: 'html', texto: '<button class="px-4 py-2 rounded bg-blue-500 text-white hover:bg-blue-600">\n  Enviar\n</button>' },
      ...
      {
        id: 'configurar',
        titulo: 'Configuração é onde o design system mora',
        corpo: [
